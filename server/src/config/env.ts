...
export const env = {
  ...
  publicData: {
    ...
    signalPageSize: parseNumber(process.env.SIGNAL_PAGE_SIZE, 200),
    signalMaxPages: parseNumber(process.env.SIGNAL_MAX_PAGES, 2),
    busRoutePageSize: parseNumber(process.env.BUS_ROUTE_PAGE_SIZE, 200),
    busRouteMaxPages: parseNumber(process.env.BUS_ROUTE_MAX_PAGES, 1),
    busStopPageSize: parseNumber(process.env.BUS_STOP_PAGE_SIZE, 300),
    busStopMaxPages: parseNumber(process.env.BUS_STOP_MAX_PAGES, 2),
    busLivePageSize: parseNumber(process.env.BUS_LIVE_PAGE_SIZE, 200),
    busLiveMaxPages: parseNumber(process.env.BUS_LIVE_MAX_PAGES, 2),
    docs: {
